...
pub mod ll {
    ...
    use libc::{c_void, c_int, c_uint, c_float, c_double, c_char, c_long, c_ulong};
    use libc::{int8_t, int16_t, int32_t, int64_t};
    ...
    pub struct Struct_SDL_assert_data {
        ...
        pub condition: *c_char,
        pub filename: *c_char,
        pub linenum: c_int,
        pub function: *c_char,
        pub next: *Struct_SDL_assert_data,
    }
    pub type SDL_assert_data = Struct_SDL_assert_data;
    pub type SDL_AssertionHandler =
        ::std::option::Option<extern "C" fn
                                (arg1: *SDL_assert_data, arg2: *mut c_void)
                                -> SDL_assert_state>;
    ...
    pub struct Struct_SDL_RWops {
        pub size: ::std::option::Option<extern "C" fn(arg1: *mut Struct_SDL_RWops)
                                            -> Sint64>,
        pub seek: ::std::option::Option<extern "C" fn
                                            (arg1: *mut Struct_SDL_RWops,
                                            arg2: Sint64, arg3: c_int)
                                            -> Sint64>,
        ...
        pub write: ::std::option::Option<extern "C" fn
                                            (arg1: *mut Struct_SDL_RWops,
                                            arg2: *c_void, arg3: size_t,
                                            arg4: size_t) -> size_t>,
        pub close: ::std::option::Option<extern "C" fn
                                            (arg1: *mut Struct_SDL_RWops)
                                            -> c_int>,
        pub _type: Uint32,
        pub hidden: Union_Unnamed1,
    }
    ...
    pub type SDL_AudioCallback =
        ::std::option::Option<extern "C" fn
                                (arg1: *mut c_void, arg2: *mut Uint8,
                                arg3: c_int)>;
    ...
    pub struct Struct_SDL_PixelFormat {
        ...
        pub Ashift: Uint8,
        pub refcount: c_int,
        pub next: *mut Struct_SDL_PixelFormat,
    }
    pub type SDL_PixelFormat = Struct_SDL_PixelFormat;
    pub struct Struct_SDL_Point {
        pub x: c_int,
        pub y: c_int,
    }
    pub type SDL_Point = Struct_SDL_Point;
    ...
    pub static SDL_WINDOW_ALLOW_HIGHDPI: c_uint = 8192;
    ...
    pub static SDL_GL_FRAMEBUFFER_SRGB_CAPABLE: c_uint = 23;
    ...
    pub static SDL_RENDER_TARGETS_RESET: c_uint = 8192;
    ...
    pub type SDL_EventFilter =
        ::std::option::Option<extern "C" fn
                                (arg1: *mut c_void, arg2: *mut SDL_Event)
                                -> c_int>;
    ...
    pub struct Struct_SDL_HapticCondition {
        ...
        pub button: Uint16,
        pub interval: Uint16,
        pub right_sat: [Uint16, ..3u],
        pub left_sat: [Uint16, ..3u],
        pub right_coeff: [Sint16, ..3u],
        pub left_coeff: [Sint16, ..3u],
        pub deadband: [Uint16, ..3u],
        pub center: [Sint16, ..3u],
    }
    ...
    pub type SDL_LogOutputFunction =
        ::std::option::Option<extern "C" fn
                                ...
                                arg3: SDL_LogPriority, arg4: *c_char)>;
    ...
    pub struct SDL_MessageBoxColorScheme {
        pub colors: [SDL_MessageBoxColor, ..5u],
    }
    pub struct SDL_MessageBoxData {
        ...
        pub colorScheme: *SDL_MessageBoxColorScheme,
    }
    ...
    pub struct Struct_SDL_RendererInfo {
        ...
        pub texture_formats: [Uint32, ..16u],
    ...
    extern "C" {
        ...
        pub fn SDL_getenv(name: *c_char) -> *mut c_char;
        pub fn SDL_setenv(name: *c_char, value: *c_char, overwrite: c_int) ->
        c_int;
        ...
        *mut c_void;
        ...
        size_t;
        pub fn SDL_strlen(str: *c_char) -> size_t;
        pub fn SDL_strlcpy(dst: *mut c_char, src: *c_char, maxlen: size_t) ->
        size_t;
        pub fn SDL_utf8strlcpy(dst: *mut c_char, src: *c_char, dst_bytes: size_t)
        -> size_t;
        pub fn SDL_strlcat(dst: *mut c_char, src: *c_char, maxlen: size_t) ->
        size_t;
        pub fn SDL_strdup(str: *c_char) -> *mut c_char;
        ...
        pub fn SDL_strchr(str: *c_char, c: c_int) -> *mut c_char;
        pub fn SDL_strrchr(str: *c_char, c: c_int) -> *mut c_char;
        pub fn SDL_strstr(haystack: *c_char, needle: *c_char) -> *mut c_char;
        pub fn SDL_itoa(value: c_int, str: *mut c_char, radix: c_int) ->
        *mut c_char;
        pub fn SDL_uitoa(value: c_uint, str: *mut c_char, radix: c_int) ->
        *mut c_char;
        pub fn SDL_ltoa(value: c_long, str: *mut c_char, radix: c_int) ->
        *mut c_char;
        pub fn SDL_ultoa(value: c_ulong, str: *mut c_char, radix: c_int) ->
        *mut c_char;
        pub fn SDL_lltoa(value: Sint64, str: *mut c_char, radix: c_int) ->
        *mut c_char;
        pub fn SDL_ulltoa(value: Uint64, str: *mut c_char, radix: c_int) ->
        *mut c_char;
        pub fn SDL_atoi(str: *c_char) -> c_int;
        pub fn SDL_atof(str: *c_char) -> c_double;
        pub fn SDL_strtol(str: *c_char, endp: *mut *mut c_char, base: c_int) ->
        c_long;
        pub fn SDL_strtoul(str: *c_char, endp: *mut *mut c_char, base: c_int) ->
        c_ulong;
        pub fn SDL_strtoll(str: *c_char, endp: *mut *mut c_char, base: c_int) ->
        Sint64;
        pub fn SDL_strtoull(str: *c_char, endp: *mut *mut c_char, base: c_int) ->
        Uint64;
        pub fn SDL_strtod(str: *c_char, endp: *mut *mut c_char) -> c_double;
        pub fn SDL_strcmp(str1: *c_char, str2: *c_char) -> c_int;
        pub fn SDL_strncmp(str1: *c_char, str2: *c_char, maxlen: size_t) -> c_int;
        pub fn SDL_strcasecmp(str1: *c_char, str2: *c_char) -> c_int;
        pub fn SDL_strncasecmp(str1: *c_char, str2: *c_char, len: size_t) ->
        c_int;
        pub fn SDL_sscanf(text: *c_char, fmt: *c_char, ...) -> c_int;
        //pub fn SDL_vsscanf(text: *c_char, fmt: *c_char, ap: va_list) -> c_int;
        pub fn SDL_snprintf(text: *mut c_char, maxlen: size_t, fmt: *c_char, ...)
        -> c_int;
        //pub fn SDL_vsnprintf(text: *mut c_char, maxlen: size_t, fmt: *c_char,
        //                     ap: va_list) -> c_int;
        pub fn SDL_acos(x: c_double) -> c_double;
        pub fn SDL_asin(x: c_double) -> c_double;
        ...
        pub fn SDL_iconv_open(tocode: *c_char, fromcode: *c_char) -> SDL_iconv_t;
        pub fn SDL_iconv_close(cd: SDL_iconv_t) -> c_int;
        pub fn SDL_iconv(cd: SDL_iconv_t, inbuf: *mut *c_char,
                        inbytesleft: *mut size_t, outbuf: *mut *mut c_char,
                        outbytesleft: *mut size_t) -> size_t;
        pub fn SDL_iconv_string(tocode: *c_char, fromcode: *c_char,
                                inbuf: *c_char, inbytesleft: size_t) ->
        *mut c_char;
        pub fn SDL_main(argc: c_int, argv: c_void) -> c_int;
        pub fn SDL_SetMainReady();
        pub fn SDL_ReportAssertion(arg1: *mut SDL_assert_data, arg2: *c_char,
                                arg3: *c_char, arg4: c_int) ->
        SDL_assert_state;
        pub fn SDL_SetAssertionHandler(handler: SDL_AssertionHandler,
                                    userdata: *mut c_void);
        pub fn SDL_GetDefaultAssertionHandler() -> SDL_AssertionHandler;
        pub fn SDL_GetAssertionHandler(puserdata: *mut *mut c_void) ->
        ...
        pub fn SDL_AtomicCAS(a: *mut SDL_atomic_t, oldval: c_int, newval: c_int)
        -> SDL_bool;
        ...
        pub fn SDL_AtomicCASPtr(a: *mut *mut c_void, oldval: *mut c_void,
                                newval: *mut c_void) -> SDL_bool;
        pub fn SDL_AtomicSetPtr(a: *mut *mut c_void, v: *mut c_void) ->
        *mut c_void;
        ...
        pub fn SDL_CondWaitTimeout(cond: *mut SDL_cond, mutex: *mut SDL_mutex,
                                ms: Uint32) -> c_int;
        pub fn SDL_CreateThread(_fn: SDL_ThreadFunction, name: *c_char,
                                data: *mut c_void) -> *mut SDL_Thread;
        pub fn SDL_GetThreadName(thread: *mut SDL_Thread) -> *c_char;
        ...
        pub fn SDL_TLSSet(id: SDL_TLSID, value: *c_void,
                        destructor:
                            ::std::option::Option<extern "C" fn
                                                        (arg1: *mut c_void)>) ->
        c_int;
        pub fn SDL_RWFromFile(file: *c_char, mode: *c_char) -> *mut SDL_RWops;
        ...
        pub fn SDL_GetPixelFormatName(format: Uint32) -> *c_char;
        ...
        *mut SDL_Surface;
        ...
        pub fn SDL_ConvertSurface(src: *mut SDL_Surface, fmt: *SDL_PixelFormat,
        ...
        *mut SDL_DisplayMode;
        ...
        pub fn SDL_CreateWindow(title: *c_char, x: c_int, y: c_int, w: c_int,
        ...
        pub fn SDL_SetWindowTitle(window: *mut SDL_Window, title: *c_char);
        pub fn SDL_GetWindowTitle(window: *mut SDL_Window) -> *c_char;
        pub fn SDL_SetWindowIcon(window: *mut SDL_Window, icon: *mut SDL_Surface);
        pub fn SDL_SetWindowData(window: *mut SDL_Window, name: *c_char,
                                userdata: *mut c_void) -> *mut c_void;
        pub fn SDL_GetWindowData(window: *mut SDL_Window, name: *c_char) ->
        *mut c_void;
        ...
        pub fn SDL_GL_GetProcAddress(_proc: *c_char) -> *mut c_void;
        ...
        pub fn SDL_GL_GetDrawableSize(window: *mut SDL_Window, w: *mut c_int,
                                    h: *mut c_int);
        ...
        pub fn SDL_JoystickName(joystick: *mut SDL_Joystick) -> *c_char;
        ...
        pub fn SDL_JoystickGetGUIDString(guid: SDL_JoystickGUID,
                                        pszGUID: *mut c_char, cbGUID: c_int);
        ...
        *mut c_char;
        ...
        pub fn SDL_GameControllerNameForIndex(joystick_index: c_int) -> *c_char;
        ...
        *mut SDL_Finger;
        ...
        pub fn SDL_GetPrefPath(org: *c_char, app: *c_char) -> *mut c_char;
        pub fn SDL_NumHaptics() -> c_int;
        pub fn SDL_HapticName(device_index: c_int) -> *c_char;
        ...
        *mut SDL_Haptic;
        ...
        pub fn SDL_SetHintWithPriority(name: *c_char, value: *c_char,
        ...
        pub fn SDL_AddHintCallback(name: *c_char, callback: SDL_HintCallback,
                                userdata: *mut c_void);
        pub fn SDL_DelHintCallback(name: *c_char, callback: SDL_HintCallback,
                                userdata: *mut c_void);
        pub fn SDL_ClearHints();
        pub fn SDL_LoadObject(sofile: *c_char) -> *mut c_void;
        pub fn SDL_LoadFunction(handle: *mut c_void, name: *c_char) ->
        *mut c_void;
        ...
        pub fn SDL_Log(fmt: *c_char, ...);
        pub fn SDL_LogVerbose(category: c_int, fmt: *c_char, ...);
        pub fn SDL_LogDebug(category: c_int, fmt: *c_char, ...);
        pub fn SDL_LogInfo(category: c_int, fmt: *c_char, ...);
        pub fn SDL_LogWarn(category: c_int, fmt: *c_char, ...);
        pub fn SDL_LogError(category: c_int, fmt: *c_char, ...);
        pub fn SDL_LogCritical(category: c_int, fmt: *c_char, ...);
        pub fn SDL_LogMessage(category: c_int, priority: SDL_LogPriority,
                            fmt: *c_char, ...);
        //pub fn SDL_LogMessageV(category: c_int, priority: SDL_LogPriority,
        //                       fmt: *c_char, ap: va_list);
        ...
        pub fn SDL_ShowSimpleMessageBox(flags: Uint32, title: *c_char,
                                        message: *c_char, window: *mut SDL_Window)
        -> c_int;
        ...
        *mut SDL_Texture;
        ...
        pub fn SDL_UpdateYUVTexture(texture: *mut SDL_Texture, rect: *SDL_Rect,
                                    Yplane: *Uint8, Ypitch: c_int, Uplane: *Uint8,
                                    Upitch: c_int, Vplane: *Uint8, Vpitch: c_int)
        -> c_int;
